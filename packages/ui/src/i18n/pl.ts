...
export const pl: Messages = {
  ...
  fx: {
    ...
    rateEditorTitle: "Ustaw {{quote}} → {{base}} dla {{from}} … {{to}}",
    rateEditorRateLabel: "Kurs",
    ...
    rateEditorConfirmOverwrite: "To zastąpi {{count}} ręcznie ustawionych kursów.",
    ...
    pivotConfirmBody:
      "Waluta bazowa to techniczny punkt odniesienia, względem którego przechowywany jest każdy kurs. Zmiana jest rzadka, audytowana i nigdy nie jest wymagana tylko dlatego, że się przeprowadziłeś.",
