...
export const en = {
  ...
  accounts: {
    ...
    /** An account's own colour (`02-tokens` §2.1b) — the editor's picker and its nine names. */
    byAccount: "By account",
    color: "Colour",
    colorOfKind: "Its kind's",
    colorBlue: "Blue",
    colorTeal: "Teal",
    colorRose: "Rose",
    colorSlate: "Slate",
  ...
  settings: {
    ...
    categoriesValue_one: "{{count}} in use",
  ...
  developer: {
    ...
    /** The loader's progress, between chunks. */
