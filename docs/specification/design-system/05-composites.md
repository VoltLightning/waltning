...
- **Open, a head may belong to its rows** — the register keeps S16's 16 above
  ...
  (`sectionHeadShut`). The head grows by that difference as it shuts.
...
currency rows (14 / 14), and the register's kind heads (21.5 / 21.5 shut).
