...
| **Quiet day** | One line |
| **Quiet run** | Two or more consecutive: **the same muted line a quiet day is, with the range on it** — *3 – 27 August ——— 25 days · nothing recorded*. Twenty-five days is not twenty-five rows. Nothing to press: it was a bordered card with a *Show* button, the loudest thing in a list of rows that actually hold something, and *Show* led to a run of days with nothing on them — what the row had already said |
